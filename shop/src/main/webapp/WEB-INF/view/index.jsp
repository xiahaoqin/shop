...
<script type="text/javascript">
	/* $(document).ready(function(){
		$.ajax({
    				type:"POST",
    				url:"<c:url value='/category.findAll2'/>",
					...
					<div class="cont clearfix">
						<ul class="prolist">
							<c:forEach begin="1" end="8">
								<li><a href=""><img src="<c:url value='/images/goods/apple.jpg'/>"
			...
			<div class="main f_l">
				<ul class="bxslider">
					<li title="新设计，新内核，新起点"><a href="" target="_blank"><img
							src="/shop/images/goods/ip7r.png"
							width="750px" height="70px" title="新设计，新内核，新起点" /></a></li>
				</ul>
			</div>
					...
					<div class="cont clearfix">
						<ul class="prolist">
							<c:forEach items="${goodsList }" var="goods">
								<li style="overflow:hidden"><a href="<c:url value='/goods.findOne/${goods.id}'/>" target="_blank"><img
										src="${goods.image }" width="175" height="175" alt="维护中" /></a>
									<p class="pro_title">
										<a title="" href=""></a>
									</p>
									<p class="brown">
