...
<body class="index">
	<div class="container">
		...
		<div class="position">
			<span>您当前的位置：</span> <a href="<c:url value='/index.action'/>">首页</a> » <a href="">${name }</a>
		</div>
				...
				<ul class="display_list clearfix m_10">
					<c:forEach items="${goodslist}" var="goods">
						<li class="clearfix win">
							<div class="pic">
								<a title="${goods.name}" href="<c:url value='/goods.findOne/${goods.id }'/>"><img
									src="${goods.image}" width="200" height="200"
							...
							<h3 class="title">
								<a title="${goods.name}" class="p_name"
									...
									class="blue" href="">( ${goods.commentNums }人评论 )</a></span><span class='grade'><i
									style='width:0px'></i></span>
							</h3>
							<div class="handle">
								<label class="btn_gray_m"><img
									src="<c:url value='/images/front/ucenter/shopping.gif'/>" width="15" height="15" /><input
