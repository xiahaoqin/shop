...
<script type="text/javascript">
	...
	function order_add(name) {
		location.href = "<c:url value='/ordersDetails.add/"+gname+"/"+$("#buyNums").val()+"'/>";
	}
</script>
			...
			<div class="summary">
				...
				<ul>
					<li><span class="f_r light_gray">商品编号：<label
							id="data_goodsNo">${goods.number}</label></span></li>
					...
					<li>顾客评分：<span class="grade"><i style="width:0px;"></i></span>(已有${goods.commentNums }人评价)
					</li>
				</ul>
				<div class="current">
					...
					<input class="submit_buy" type="button" id="buyNowButton"
						value="立即购买" onclick="order_add('${goods.name}')" />
				...
				<div name="showBox">
					...
					<div class="hidden comment_list box">
						<div class="title3">
							<span class="f_r f12 light_gray normal"> 只有购买过该商品的用户才能进行评价
								...
								class="f12 normal">（已有<b class="red2">${goods.commentNums }</b>条）
							</span>
						</div>
					...
					<div class="hidden box">
						<div class="title3">
							...
							购买记录<span class="f12 normal">（已有<b class="red2">${goods.total }</b>购买）
							</span>
						</div>
